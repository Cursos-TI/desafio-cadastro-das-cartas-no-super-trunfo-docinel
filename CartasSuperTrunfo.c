...
int main()
{
    ...
    char NomeCidade[15]; // {'SaoPaulo', 'RiodeJaneiro', 'Brasilia', 'Fortaleza', 'Salvador',
                        //'BeloHorizonte', 'Manaus', 'Curitiba', 'Recife', 'Goiânia', '\0'}
    ...
    printf("\nAs cidades são: SaoPaulo, RiodeJaneiro, Brasilia, Fortaleza, \nSalvador, BeloHorizonte, Manaus, Curitiba, Recife, Goiania\n");
    ...
    DensidadePopulacional = populacao / area; // hab/km²
    PibPerCapita = PIB / populacao; // reais
